...
video_folder_path = "/Users/alessiacolumban/Desktop/TeamProject-GradindSysAthletes/Athletes/KeypointDetection/exercises/Verspringen"
output_json_path = "/Users/alessiacolumban/Desktop/TeamProject-GradindSysAthletes/Athletes/KeypointDetection/JsonKeypoints/Verspringen.json"
...
for video_file in video_files:
    ...
    while True:
        ...
        if frame_count % 5 == 0 and closest_bbox is not None:
            ...
            # Add image info to COCO annotations, including the video name
            coco_annotations["images"].append({
                "id": image_id,
                "file_name": f"{video_file}_frame_{frame_count:06d}.jpg",
                "width": frame.shape[1],
            ...
            print(f"Processed frame {frame_count} from {video_file}")
